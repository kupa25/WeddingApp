...
{
    /// <summary>
    /// Phone application page for Pictures_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Pictures_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Pictures_Detail and all its components.
        /// </summary>
        public Pictures_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaPictures_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaPictures_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaPictures_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaPictures_Detail(PanoramaPictures_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaPictures_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IPictures_FlickrPics>();
				AddHomeAppBarButton();
				var pinnedItemSpec = new FilterSpecification().AddPredicate("Image", ColumnOperatorEnum.Equals, currentId);
				var pinnedItem  = (await dataSource.Search(pinnedItemSpec)).FirstOrDefault();
				if(pinnedItem==null)
					MessageBox.Show(Localization.AppResources.PinError);
				((IViewModels.IPictures_DetailViewModel)DataContext).CurrentFlickrSearchResult = pinnedItem;				
			}
		}
