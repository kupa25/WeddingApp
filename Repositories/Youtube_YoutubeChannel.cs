...
namespace WPAppStudio.Repositories
{
    ...
    public class Youtube_YoutubeChannel : IYoutube_YoutubeChannel 
    {
		...
		private const string YoutubeQuery = @"janwartoday";
		private const string YoutubePaginationParameters = "&start-index={1}&max-results={2}";

        /// <summary>
        /// Initializes a new instance of the <see cref="Youtube_YoutubeChannel" /> class.
        /// </summary>
        /// <param name="youtubeDataSource">A Youtube data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Youtube_YoutubeChannel(RepositoriesBase.IYoutubeDataSource youtubeDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: janwartoday ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: janwartoday ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (channel: janwartoday ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        {
			var data = _storageService.Load<EntitiesBase.YouTubeVideo[]>("Youtube_YoutubeChannel");
        ...
        {
			var data = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Youtube_YoutubeChannel");
        ...
        {
			var storedItems = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Youtube_YoutubeChannel");
            ...
            if (_internetService.IsNetworkAvailable() && (pageNotSaved || forceRecaching))
            {
                ...
                if(newItems != null && newItems.Any())
				{
					...
					_storageService.Save("Youtube_YoutubeChannel", new ObservableCollection<EntitiesBase.YouTubeVideo>(storedCollection));
				}
			}
